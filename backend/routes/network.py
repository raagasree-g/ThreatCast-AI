...
from backend.data.network import get_latest_network_graph, get_network_graph, get_network_activity
...
def read_latest_network_graph():
    """Return the real topology generated by the most recent upload."""
    return get_latest_network_graph()
